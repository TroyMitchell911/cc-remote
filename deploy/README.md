...
Protocol v40 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v40 relay/web release; then start the v40 wrapper.
...
verify v40, and retain that snapshot with the previous release. To roll back,
stop v40, run `work_registry_snapshot.py restore`, then switch and start the old
