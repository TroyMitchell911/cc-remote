...
Protocol v41 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v41 relay/web release; then start the v41 wrapper.
...
verify v41, and retain that snapshot with the previous release. To roll back,
stop v41, run `work_registry_snapshot.py restore`, then switch and start the old
